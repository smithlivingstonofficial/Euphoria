...
const SCHOOL_MAP = {
  ...
  "SAS": "SAS (School of Advanced Sciences)",
  "SLASE": "SLASE (School of Liberal Arts & Education)",
  "AHS": "AHS (Allied Health Sciences)",
  "KSoL": "KSoL (Kalasalingam School of Law)",
  "KSL": "KSoL (Kalasalingam School of Law)",
  "FE": "FE (First Year Engineering & Foundation)",
  "KSAH": "KSAH (School of Agriculture & Horticulture)",
  "KSA": "KSA (Kalasalingam School of Architecture)",
  "KSoA": "KSA (Kalasalingam School of Architecture)",
  "SBCE": "SBCE (Bio & Chemical Engineering)",
  "KAP": "KAP (Kalasalingam Academy of Pharmacy)",
  "Pharmacy": "KAP (Kalasalingam Academy of Pharmacy)",
