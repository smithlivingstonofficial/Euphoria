            ...
            <div className="space-y-3.5">
              ...
              <div className="grid grid-cols-5 gap-2.5">
                ...
                <div className="col-span-3">
                  ...
                  <div
                    className={`flex rounded-lg border bg-white overflow-hidden transition-colors ${
                  ...
                  >
                    <div className="flex items-center px-2.5 bg-slate-50 border-r border-slate-200 text-xs font-semibold text-slate-600 select-none shrink-0">
                      +91
                    </div>
                    <input
                      type="tel"
                      ...
                      className="w-full bg-transparent px-3 py-2 text-xs sm:text-sm font-mono text-slate-900 placeholder:text-slate-400 focus:outline-none"
                    />
                  </div>
                </div>
              </div>
